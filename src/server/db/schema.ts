...
export const form = createTable(
    ...
    (form) => {
        return {
            ...
            googleFormIdIdx: index("form_google_form_id_idx").on(
                form.googleFormId,
            ),
        };
    },
...
export const formResponse = createTable(
    ...
    (formResponse) => ({
        ...
        uniqueResponseConstraint: uniqueIndex(
            "unique_form_response_constraint",
        ).on(formResponse.googleResponseId, formResponse.formId),
    }),
);
...
export const formFieldResponse = createTable(
    ...
    (formFieldResponse) => ({
        formResponseIdIdx: index(
            "form_field_responses_form_response_id_idx",
        ).on(formFieldResponse.formResponseId),
